#ifndef YOLOFASTESTV2_H_INCLUDED
#define YOLOFASTESTV2_H_INCLUDED
...
private:
    ...
    int interHandle(std::vector<TargetBox>& tmpBoxes, std::vector<TargetBox>& dstBoxes);
...
#endif // YOLOFASTESTV2_H_INCLUDED
